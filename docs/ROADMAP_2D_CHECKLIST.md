...
| G.3 reference parity 재구축 | **계획·승인 대기** | [후보 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[평가 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md) | 구현 전, 자동 점수만으로 승인 금지 | 1920×1080 UI 100/125와 river·heat·flood 포함 예정 | target→vertical slice→전체 상태 3회 owner gate | 구현 권한 없음·검토 미실행 |

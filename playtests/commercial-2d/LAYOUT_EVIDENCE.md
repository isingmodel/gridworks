...
- 지면은 400 내부단위 셀마다 asphalt 기반 PNG를 실제로 반복하고 scrub·concrete·gravel PNG를 낮은
  농도의 개별 변형층으로 적용한다. 셀 경계선이나 gameplay 격자를 그리지 않는다.
...
세 화면은 native OpenGL/Metal process에서 저장했다. 최소 지원·검수 해상도는 1920×1080뿐이며

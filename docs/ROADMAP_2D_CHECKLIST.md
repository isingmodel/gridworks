...
| UX-87. 상용 게임 경험 | **활성** | [활성 계약](scopes/COMMERCIAL_UX_87.md)·[고정 평가 프로토콜](product/COMMERCIAL_UX_EVALUATION_PROTOCOL_KO.md)·동결 v2 world/campaign | story 단독 실행·coverage와 전체 회귀 구현 전 | 개발자 pilot에서 briefing 가림·result/next 혼선·재개 재안내 확인; 공식 cold 미실행 | `NOT_COLLECTED`; LLM은 사람 증거가 아님 | `gpt-5.6-sol` ultra text baseline → 3 cold actor+3 blind judge `CommercialUXProxy >=87`, P0/P1 0 필요 |

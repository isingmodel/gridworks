...
| R. 실시간 물리 세계 전면 개편 | **활성 · R1 Core vertical slice** | [새 구현 계약](scopes/REALTIME_PHYSICAL_TOTAL_REVISION.md)·R0 `5a9e465` 완료·별도 V3 world/campaign | 동결 v2 30 suites / 5,739 assertions와 Game 3구성 0/0 기준선 PASS; R1 수집 중 | 미수집 | §13.3 후속 validation `NOT_COLLECTED` | R0 독립 P0/P1 0; R1~R7 전체 gate 전에는 구현 완료 아님 |

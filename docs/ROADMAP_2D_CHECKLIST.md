...
| G.3 reference parity 재구축 | **활성** | [활성 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[LLM judge 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md) | 48개 asset provenance·kit sheet, `gpt-5.6-sol` ultra×10 pairs×2 order×2 replicate, calibration·blind verification 필수 | 1920×1080 UI 100/125와 river·heat·flood | 사람 review 제외; target→asset/vertical slice→전체 상태 고정 judge 3회 | `ReferenceParity >96`까지 반복·judge 미실행 |

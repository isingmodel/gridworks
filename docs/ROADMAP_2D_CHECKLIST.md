...
| G.3 reference parity 재구축 | **계획 완료·구현 대기** | [후보 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[LLM jury 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md) | 서로 다른 family 3 judges×2 order×2 replicate, calibration·adjudication 필수 | 1920×1080 UI 100/125와 river·heat·flood 포함 예정 | 사람 review 제외; target→vertical slice→전체 상태 LLM jury 3회 | 구현 권한 없음·jury 미실행 |

...
│   ├── SCOPE_1_INTERACTION.md         구현 대기 중인 수동 선로 계약
...
| 다음으로 선택된 수동 선로 Interaction의 경계는 무엇인가? | [Scope 1 준비 계약](scopes/SCOPE_1_INTERACTION.md) | 별도 승인 없이 구현·fixture·공식 실행을 열지 않음 |

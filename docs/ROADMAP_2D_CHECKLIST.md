...
| G.2 개별 tile·object art | **완료** | [G.2 종료 기록](scopes/COMMERCIAL_2D_IMPLEMENTATION.md#78-단계-g2-종료-기록-2026-08-21)·동결 v2 data | CommercialChecks 22 suites / 2,024 assertions, 동결 회귀·16개 mapping·plate 부재 통과 | 1920×1080 UI 100/125 actual-input 화면 5장, live draft·timeline, 자유 배치·열·campaign과 clean macOS ZIP 통과 | G.1 plate 방식 거부 반영; 수정 후보 전체 플레이 `NOT_COLLECTED` | exact `c1c4f35` P0 0 / P1 0 / open 0 |

...
A는 3.8 km·12철탑·18.4 M·52일이고, 기존 선로와 같은 상위 모선·보호구역을 공유하므로
전기 단일고장 뒤 독립 경로가 남지 않아 `N-1: NO`다. 강 횡단 접근부의 회랑 공유는 별도의
공통원인 위험도 높인다. B는 5.1 km·15철탑·19.6 M·58일이며, 별도 발전 측 모선·보호구역과
도로 회랑으로 접속해 `N-1: YES`다. 즉 N-1과 공간 공통위험은 따로 판정하며, B는 둘 다
개선한다. 지도 위 유령 철탑, 꺾임점과 경고·방패 표식이 우측 견적 카드에 직접 대응한다.
...
카드의 2.4 km/6.8 km는 `주거지 최단거리`, 송출 견적의 1.85 km/6.9 km는 실제
`송전 경로 길이`다. 두 거리를 같은 `DISTANCE`로 표시하지 않는다. 마을에서 2.4 km 떨어진
A는 송전선이 짧지만 원전 건설비가 `×2.5`가 되어 본체 420 M에
입지 할증 630 M이 붙는다. 2×345 kV 송출망과 1,200 MW 허브 90 M까지 합한 총액은
1,140 M, 완공은 630일 뒤다. 주거지에서 6.8 km 떨어진 B는 님비 할증이 없지만 6.9 km의
긴 복수회선·특수경간·

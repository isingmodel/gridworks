...
| G.3 reference parity 재구축 | **활성 — Step 2 원자 강물·제방** | [활성 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[LLM judge 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md)·[Step 1 PASS 증거](../playtests/commercial-2d/g3-work-in-progress/atomic-step1-final/README.md) | Step 1: 12 atomic city asset·80 city + 40 road instance·package-eligible 합성 후보 0·CommercialChecks 22/2,153 PASS; final raster ≥53와 전체 jury는 진행 중 | Step 1: 1920×1080 UI 100/125 actual-input presentation, placement 전체 보기·Q/E PASS; Step 2 river·heat·flood 진행 | 사람 review 제외; `gpt-5.6-sol` ultra atomic audit 12/12 true, baked-city=false | Step 1 PASS; Step 2 활성·`ReferenceParity >96`까지 반복 |

...
이 파일은 문서의 역할과 질문별 소유권을 정한다. 프로젝트의 현재 상태와 구현 권한은 루트
[README](../README.md)가 소유한다. 현재 활성 구현 단계는 없으며, 로드맵에 적힌 기능은 자동
승인된 backlog가 아니다.
...
4. 필요한 경우 [개발 이력](DEVELOPMENT_HISTORY.md)과 두 구현 기준

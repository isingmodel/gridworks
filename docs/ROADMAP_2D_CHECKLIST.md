...
| G.3 reference parity 재구축 | **활성 — Step 3 원자 grid/facility·전력망** | [활성 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[LLM judge 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md)·[Step 1 증거](../playtests/commercial-2d/g3-work-in-progress/atomic-step1-final/README.md)·[Step 2 증거](../playtests/commercial-2d/g3-work-in-progress/river-step2-final/README.md) | Step 1: city 12종·road 6종·80+40 instance; Step 2: river 12종·authoritative 굽은 수로·3상태; CommercialChecks 22/2,265 PASS; final raster ≥53와 전체 jury 진행 중 | 1920×1080 UI 100/125 actual-input presentation·placement PASS; normal/heat/flood 강 캡처 PASS | 사람 review 제외; `gpt-5.6-sol` ultra city 12/12·river 12/12 atomic audit, baked-city/river=false, 강 3상태=true | Step 1·2 PASS; Step 3 활성·`ReferenceParity >90`까지 반복 |

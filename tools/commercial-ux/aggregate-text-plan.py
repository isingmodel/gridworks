...
RUBRIC_SCHEMA = "gridworks.commercial-ux.rubric.v2"
JUDGMENT_PROTOCOL = "GRIDWORKS-REALTIME-COMMERCIAL-UX-TEXT-PLAN-JUDGMENT-v2"
AGGREGATE_PROTOCOL = "GRIDWORKS-REALTIME-COMMERCIAL-UX-TEXT-PLAN-AGGREGATE-v2"
REPLACEMENT_RECEIPT_SCHEMA = "gridworks.commercial-ux.text-plan-replacement-receipt.v2"
...
FROZEN_TEXT_CONTRACT_SHA256 = "sha256:d94d2668128f8b44b972c02ee44557290b55a41facf1625e81c2f687588f7ae7"
...
def load_judge_contract() -> tuple[str, str]:
    ...
    contract_path = Path(__file__).with_name("realtime_text_contract.py")
    prompt_sha256 = file_sha256(prompt_path, "judge prompt template")
    schema_sha256 = file_sha256(schema_path, "judge schema")
    contract_sha256 = file_sha256(contract_path, "realtime text contract")
    ...
    if contract_sha256 != FROZEN_TEXT_CONTRACT_SHA256:
        fail(
            "realtime text contract hash drift: "
            f"expected {FROZEN_TEXT_CONTRACT_SHA256}, got {contract_sha256}"
        )

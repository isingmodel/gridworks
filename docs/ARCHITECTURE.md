...
│     └─ resource load + RealtimeCampaignSaveCodec.Restore → validated Continue availability
│        └─ ContinueRequested → Product write ownership
│           └─ RealtimeSession.Resume(paused, no modal)

...
가능한 1.0 게임은 아니다. 남은 1장과 전체 캠페인 완결성, R2 저장/재개, 제품용 audio·settings,
...
| 구현된 7장 누적 플레이 | `./dev play through SWITCH_OFF_TO_PROTECT` |

예를 들어 현재 구현된 7장 경로는 다음과 같이 실행한다.

```sh
./dev play through SWITCH_OFF_TO_PROTECT
```

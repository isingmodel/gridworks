...
공간사건 결산에 이어 가스발전소 직접 건설·계통접속과 공장 공급까지 통합했다. 완공 자산 철거는
아직 구현되지 않았다.
...
| 공장 | `현재`. authored 산업 수요처, 전력회사 소유 아님 | 발효된 큰 수요와 공급 부족, 신규 발전소 접속 뒤 공급 확인 | 큰 고정 부하와 authored feeder | 생성·건설·철거·수요반응. 유상 감축은 조건부 후보 |

...
| G.1 소유자 시각 정렬 | **활성** | [G.1 계약](scopes/COMMERCIAL_2D_IMPLEMENTATION.md#75-단계-g1-소유자-시각-정렬-수정)·동결 v2 data | 기존 rule 회귀 유지, 새 timeline presentation 검사 예정 | 1920×1080 UI 100/125 actual-input 화면 재검수 예정 | 소유자 피드백: concept 거리·timeline 누락 확인 | 구현 뒤 bounded exact-tree 검토 예정 |

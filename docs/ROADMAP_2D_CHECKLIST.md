...
| 1. 분기형 배전망 기초 | **검토 중** | [활성 계약](scopes/RELEASE_REBUILD.md)·[world 데이터](../data/release-world-v1.json) | [9 suites / 148 assertions](../tools/Gridworks.ReleaseChecks/Program.cs), 과거 회귀 통과 | Game 기본 장면 변경 없음 | 해당 없음 | 독립 P0/P1 검토 중 |

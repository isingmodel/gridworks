...
- 누적 8장 product의 모든 장 stable 진행, story-idle active event·duty, exact-minute active
  ...
  in-progress read와 정상 종료 current v3 write: deterministic wiring 완료
...
documented safe-point save/resume와 readable save reset, audio/settings와 fresh-install candidate

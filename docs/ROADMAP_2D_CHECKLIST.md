...
| UX-87. 상용 게임 경험 | **활성** | [활성 계약](scopes/COMMERCIAL_UX_87.md)·[고정 평가 프로토콜](product/COMMERCIAL_UX_EVALUATION_PROTOCOL_KO.md)·동결 v2 world/campaign | 26 story selector·17 typed failure, CommercialChecks 24/2,910, text self-test·Debug/Release PASS | Gate C 6-mode 후보의 fresh campaign·임무 5 draft를 잇는 3-process resume·1920×1080 UI 100/125 presentation PASS; 공식 cold 미실행 | `NOT_COLLECTED`; LLM은 사람 증거가 아님 | Gate C exact fix 독립 재검토 P0/P1/P2 0; 다음은 3 cold actor+3 blind judge와 `CommercialUXProxy >=87` |

...
internal sealed partial class Scope1PlacementMapView : Control
{
    ...
    private Scope1Fixture? _scenario;
    ...
    public Vector2 ViewportPointForGridPoint(Scope1Point point)
    {
        Scope1Fixture scenario = _scenario
            ?? throw new InvalidOperationException("Map model is not ready.");
        Vector2 localPoint = ToCanvas(point, scenario, PlotRect(scenario));
    ...
    private void DrawGrid(Scope1Fixture scenario, Rect2 plot)
    {
    ...
    private void DrawRange(Scope1Fixture scenario, Scope1View view, Rect2 plot)
    {
        ...
        DrawString(
            ...
            $"MaxSpan {scenario.MaxSpan} {scenario.Units.Position}",
            HorizontalAlignment.Left,
            -1f,
            13,
            RangeColor);
    ...
    private void DrawPath(Scope1Fixture scenario, Scope1View view, Rect2 plot)
    {
    ...
    private void DrawGhost(Scope1Fixture scenario, Scope1View view, Rect2 plot)
    {
    ...
    private void DrawEndpoints(Scope1Fixture scenario, Scope1View view, Rect2 plot)
    {
    ...
    private void DrawSupports(Scope1Fixture scenario, Scope1View view, Rect2 plot)
    {
    ...
    private bool TrySnap(Vector2 localPosition, Scope1Fixture scenario, out Scope1Point point)
    {
    ...
    private static Vector2 ToCanvas(Scope1Point point, Scope1Fixture scenario, Rect2 plot)
    {
        float scale = GridScale(scenario, plot);
        return new Vector2(
    ...
    private Rect2 PlotRect(Scope1Fixture scenario)
    {
    ...
    private static float GridScale(Scope1Fixture scenario, Rect2 plot)
    {
        float spanX = scenario.MapBounds.MaxX - scenario.MapBounds.MinX;
        return plot.Size.X / spanX;
    }

    private static Scope1Point LastEndpoint(Scope1Fixture scenario, Scope1View view) =>

...
| 3. 프롤로그·본편 캠페인 | **검토 중** | [활성 계약](scopes/RELEASE_REBUILD.md)·[캠페인 데이터](../data/release-campaign-v1.json) | 15 suites / 429 assertions | 8장·fresh-process 저장·재시작 통과 | 전체 한국어 검토는 4단계 | 독립 검토 진행 중 |

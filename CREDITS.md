...
`game/art/commercial/g3-assets.prompts.md`에 역사 ledger로 보존한다. 그 원문의 단계별 수량·package
표현은 당시 checkpoint 기록이고 현재 사용 경계는 [ASSET_MANIFEST.md](ASSET_MANIFEST.md)가 소유한다.
...
초상 자산의 현재 사용 여부도 같은 자산 안내가 소유한다.

...
| G.3 reference parity 재구축 | **활성 — Step 4 UI chrome·full-bleed HUD·event timeline** | [활성 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[LLM judge 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md)·[Step 1 증거](../playtests/commercial-2d/g3-work-in-progress/atomic-step1-final/README.md)·[Step 2 증거](../playtests/commercial-2d/g3-work-in-progress/river-step2-final/README.md)·[Step 3 증거](../playtests/commercial-2d/g3-work-in-progress/grid-step3-final/README.md) | Step 1 city/road, Step 2 river, Step 3 grid/facility hard gate PASS; CommercialChecks 22/2,286; UI chrome 6종과 final raster ≥53 진행 중 | 1920×1080 UI 100/125 actual-input presentation·placement·thermal PASS; normal/heat/flood·grid draft 캡처 PASS | 사람 review 제외; `gpt-5.6-sol` ultra city 12/12·river 12/12·grid 8/8 atomic audit, baked city/river/grid=false, 상태 식별=true | Step 1·2·3 PASS; Step 4 활성·`ReferenceParity >90`까지 반복 |

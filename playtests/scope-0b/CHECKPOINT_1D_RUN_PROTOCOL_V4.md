...
> Historical status: **REVIEWED — official v4 sessions authorized**
>
> Superseded: v4 and v5 later closed `PROXY-RUN-BLOCKED`; current state is owned by the official
> [result](RESULT.md) and [decision checkpoint](CHECKPOINT_2_DECISION.md). This banner no longer authorizes a launch.
>

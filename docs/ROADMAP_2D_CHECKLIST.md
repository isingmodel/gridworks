...
| G.3 reference parity 재구축 | **활성 — Step 4 구현·formative 완료, 최종 parity 미달** | [활성 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[LLM judge 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md)·[formative-v26 증거](../playtests/commercial-2d/g3-final-candidate/FORMATIVE_V26_SUMMARY.md) | Step 1~3 hard gate PASS; Step 4 UI chrome 6종·55 individual art·338 city/641 world instance; CommercialChecks 22/2,331 PASS | native 1920×1080 actual-input checkpoint→completion→completed-resume PASS; 동일 v26 normal/heat/route/siting/flood 캡처 | 사람 review 제외; `gpt-5.6-sol` ultra 10-pair 단일-call formative 완료, category proxy 74.375, density/river 65 | 이번 Step 4 완료; 공식 10×4 jury와 `ReferenceParity >80`은 미달·다음 반복으로 유지 |

...
- Current active scope: `docs/scopes/SCOPE_1_INTERACTION.md`
- Historical preparation: `playtests/scope-1/CHECKPOINT_0_CONTRACT_PREPARATION.md`
- Before fixture review, the Scope 1 contract's JSON skeleton remains the numeric authority.
- After a reviewed fixture handoff, `data/scope-1-v1.json` becomes the sole machine authority.
- Completed Scope 0B source, fixture, scene and evidence remain immutable regression boundaries.

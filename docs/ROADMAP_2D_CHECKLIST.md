...
> [로드맵](ROADMAP_2D.md), [완료 구현 계약](scopes/COMMERCIAL_2D_IMPLEMENTATION.md)과 현재
> [상용 UX 87 계약](scopes/COMMERCIAL_UX_87.md)이 소유한다.
...
| G.1 소유자 시각 정렬 | **완료·대체됨** | [G.1 종료 기록](scopes/COMMERCIAL_2D_IMPLEMENTATION.md#76-단계-g1-종료-기록-2026-08-21)·동결 v2 data | CommercialChecks 21 suites / 1,828 assertions, 동결 회귀·promise 결과 timeline 검사 통과 | 1920×1080 UI 100/125 actual-input 화면, 자유 배치·열·세 campaign process와 clean macOS ZIP 통과 | whole-map plate 방식 소유자 거부; G.2가 대체 | candidate P0 0 / P1 2는 당시 수정됐으나 G.2 증거로 합산하지 않음 |
| G.2 개별 tile·object art | **기술 완료·시각 거부** | [G.2 종료 기록](scopes/COMMERCIAL_2D_IMPLEMENTATION.md#78-단계-g2-종료-기록-2026-08-21)·동결 v2 data | CommercialChecks 22 suites / 2,024 assertions, 동결 회귀·16개 mapping·plate 부재 통과 | 1920×1080 actual-input 증거는 있으나 owner screenshot에서 camera·밀도·강·scale 불일치 확인 | G.1 plate 제거는 반영했으나 reference parity 거부 | exact review는 logic P0/P1 0이었으나 시각 승인으로 합산하지 않음 |
| G.3 reference parity 재구축 | **완료 — v27 사용자 승인 종료** | [완료 계획](product/COMMERCIAL_2D_REFERENCE_PARITY_PLAN_KO.md)·[LLM judge 프로토콜](product/REFERENCE_PARITY_EVALUATION_PROTOCOL_KO.md)·[v27 증거](../playtests/commercial-2d/g3-final-candidate/FORMATIVE_V27_SUMMARY.md) | Step 1~3 hard gate PASS; UI chrome 6종·55 individual art·338 city/641 world instance; CommercialChecks 22/2,331 PASS; Debug·Release 0/0 | native 1920×1080 UI 100/125 presentation과 actual-input checkpoint→completion→completed-resume PASS; v27 6 capture 고정 | 사람 review 없음; `gpt-5.6-sol` ultra 10-pair 단일-call formative proxy 74.375; official `ReferenceParity=null` | 자동 `>80` gate를 달성한 것으로 표기하지 않음; 사용자가 v27 점수와 무관한 성공 종료를 명시해 단계 완료, 남은 density/river/grid/state=65 보존 |
| UX-87. 상용 게임 경험 | **활성 — `BLOCKED_PRE_CAPTURE`** | [활성 계약](scopes/COMMERCIAL_UX_87.md)·[고정 평가 프로토콜](product/COMMERCIAL_UX_EVALUATION_PROTOCOL_KO.md)·[native v1.1 부록](product/COMMERCIAL_UX_NATIVE_EVALUATOR_ADDENDUM_KO.md)·동결 v2 world/campaign | 26 story selector·17 typed failure, CommercialChecks 24/2,910 PASS; native schema 36·contract 54·gold 25·session 16·aggregate 78 PASS; candidate overlay 56-pair exact Core replay PASS; text v2 94.6625는 `SCORED_FORMATIVE`이지만 155 supported/22 partial로 `BLOCKED_EVIDENCE_VERIFICATION` | Gate C smoke는 개발 증거로만 PASS; checked-in gold owner 52 pending·E09 owner 4 unbound, 17 deterministic producer binding 미완료, 공식 cold/native 미실행 | `NOT_COLLECTED`; LLM은 사람 증거가 아님 | Gate C·replay authority `87bad71`+`8a69b95`·pre-terminal DAG `61c1df5` exact 재검토 P0/P1/P2 0; producer를 닫은 뒤 3 cold actor+coverage·3 blind judge, official `CommercialUXProxy >=87` |
